...
5. **Scale**: *Two **scales** can be checked for equality, inequality, or partial equality (I.e. permutation). A **scale** and a **mode** *
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMDI5Nzg5NiwtMTMyODU2NTQ1XX0=
-->